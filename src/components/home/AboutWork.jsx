...
const AboutWork = () => {
    ...
    return (
        <>
            <div className=" wht_built_pren w-full  h-screen gap-y-12  text-[#18293A] flex justify-center px-10 flex-col ">
                <h2 className="uppercase text-2xl">What I’ve built</h2>
                <div className="w-full relative grid grid-cols-2 pt-3 ">
                    <div className="tin_line w-0  absolute h-px bg-[#18293A] top-0 left-0"></div>
                    <div className="">
                ...
                <div className="w-full relative z-20 text-xl vvds_light grid grid-cols-4 ">
                    ...
                    <div className="w-full relative  p-12  ">
                        <div className="tin_line_ver h-0  absolute w-px bg-[#18293A] top-0 right-0"></div>
                        <h2>25+</h2>
            ...
            <div className="spn_slide_paren relative py-[10vw]  w-full  z-10 bg-transparent ">
                <div className="  spn_slide    center w-[100%] ">
                    <h2 className='text-[#18293A] text-5xl w-[72%]  text-justify  leading-none'>
